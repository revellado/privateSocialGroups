...
namespace PapelClub.Modules.DNNPrivateSocialGroups.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "PapelClub.Modules.DNNPrivateSocialGroups.Data.SqlDataprovider,DNNPrivateSocialGroups";
